                            ...
                            children: <Widget>[
                              Column(children: <Widget>[
                                if (widget.list[i]['nombreproyecto'] == null)
                                  ...
                                  Column(
                                    children: [
                                      if (widget.list[i]["idtipomovimiento"] ==
                                          "1")
                                        Column(
                                          children: [
                                            Row(
